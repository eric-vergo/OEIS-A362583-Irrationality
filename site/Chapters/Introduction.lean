...
A statement-hygiene principle governs the Lean development: the four definitions and the two
headline theorems mention only elementary objects — the $`k`-th prime, remainder arithmetic,
